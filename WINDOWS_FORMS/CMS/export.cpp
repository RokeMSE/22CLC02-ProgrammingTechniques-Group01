...
void exportStudents() {
    ...
    ofs << "username,password,studentID,firstname,lastname,gender(0-male/1-female),DateofBirth(mm/dd/yyyy),socialID,CLASS";
    ...
    while (cur) {
        ...
        ofs << cur->data->studentID << ',' << cur->data->firstname << ',' << cur->data->lastname << ',';
        ofs << cur->data->gender << ',';

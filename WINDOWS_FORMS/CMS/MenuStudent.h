...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// btn_stuViewCourses
			// 
			this->btn_stuViewCourses->Location = System::Drawing::Point(25, 123);
			this->btn_stuViewCourses->Name = L"btn_stuViewCourses";
			this->btn_stuViewCourses->Size = System::Drawing::Size(376, 58);
			...
			this->btn_stuViewCourses->Click += gcnew System::EventHandler(this, &MenuStudent::btn_stuViewCourses_Click);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(488, 123);
			...
			// btn_logout
			// 
			this->btn_logout->Location = System::Drawing::Point(623, 205);
			this->btn_logout->Name = L"btn_logout";
			this->btn_logout->Size = System::Drawing::Size(119, 30);
			...
			// btn_exit
			// 
			this->btn_exit->Location = System::Drawing::Point(160, 205);
			this->btn_exit->Name = L"btn_exit";
			this->btn_exit->Size = System::Drawing::Size(119, 30);
...
#pragma endregion
	...
	private: System::Void btn_stuViewCourses_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Hide();
		ViewListCoursesOfStu^ form = gcnew CMS::ViewListCoursesOfStu(this);
		form->Show();
	}
};
}